...
class AirbotDataset(tfds.core.GeneratorBasedBuilder):
    ...
    MANUAL_DOWNLOAD_INSTRUCTIONS = "Please place the dataset files in the specified `manual_dir`."


    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # self._embed = hub.load("/home/dodo/.cache/tfhub_modules/google/universal-sentence-encoder-large/5"
